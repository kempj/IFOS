#!/bin/bash
#SBATCH -J run-INV-IFOS      # job name
#SBATCH -o run-INV-IFOS.o%j  # output and error file name (%j expands to jobID)
#SBATCH -N 2                    # total number of nodes requested
#SBATCH --ntasks-per-node 1    # total number of processors on each node
