	 ...
	 case 101 :         
	  ...
	  case 132 :
	   fscanf(fp_in,"%s =%i",s,&FILT_SIZE_GRAD);                         
            break;
	  case 133 :
	   fscanf(fp_in,"%s =%i",s,&ZERO_PHASE);                         
            break; 
	  case 134 :
	   fscanf(fp_in,"%s =%f",s,&F_REF);                         
            break;   
	  case 135 :
	   fscanf(fp_in,"%s =%i",s,&VELOCITY);
	    break;  
	  case 136 :
	   fscanf(fp_in,"%s =%i",s,&SWS_TAPER_FILE_PER_SHOT);
	    break; 
	  case 137 :
	   fscanf(fp_in,"%s =%s",s,TAPER_FILE_NAME);
	    break;
	  case 138 :
	   fscanf(fp_in,"%s =%s",s,TAPER_FILE_NAME_U);
	    break;
	  case 139 :
	   fscanf(fp_in,"%s =%s",s,TAPER_FILE_NAME_RHO);
	    break;
	  case 140 :
	   fscanf(fp_in,"%s =%f",s,&TSHIFT_back);
	    break;
	   case 141 :
	   fscanf(fp_in,"%s =%f",s,&WATERLEVEL_LNORM8);
	    break; 
	   case 142 :
	   fscanf(fp_in,"%s =%f",s,&VP_VS_RATIO);
	    break; 
	    case 143 :
	   fscanf(fp_in,"%s =%i",s,&S);
	    break;
	    case 144 :
	   fscanf(fp_in,"%s =%f",s,&S_VS);
	    break;
	    case 145 :
	   fscanf(fp_in,"%s =%f",s,&S_VP);
	    break;
	    case 146 :
	   fscanf(fp_in,"%s =%f",s,&S_RHO);
	    break;
	    case 147 :
	   fscanf(fp_in,"%s =%i",s,&GRAD_FILT_WAVELENGTH);
	    break;
	    case 148 :
	   fscanf(fp_in,"%s =%f",s,&A);
	    break;
            case 149 :
           fscanf(fp_in,"%s =%s",s,FREQ_FILE);
            break;
	 default:
	    break;
	 }
